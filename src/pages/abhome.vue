      ...
      <v-row class="mt-16" style="height:auto">
        <v-col cols="12" sm="8" md="8" lg="8">
          ...
          <div class="btn"  data-aos="fade-right" data-aos-duration="1000">
            <v-btn color="primary" style="min-width: 200px;" variant="tonal" target="_blank" href="https://drive.google.com/file/d/1pZHca13VQ8N79n0xyhrtEv-TEmcMSDKz/view?usp=sharing" class="bt mr-3"
