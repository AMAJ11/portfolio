<template>
  <div class="pro">
    <swiper :effect="'coverflow'" :grabCursor="true" :centeredSlides="true" :slidesPerView="'auto'" :coverflowEffect="{
      ...
      modifier: 1,
      slideShadows: true,
    }" :pagination="true" :modules="modules" class="mySwiper hidden-sm-and-down">
      <swiper-slide>
        <v-card>
          <v-card-title primary-title> Social media WebApp </v-card-title>
          <img src="../assets/WhatsApp Image 2025-05-10 at 6.19.27 PM.jpeg" />
      ...
      <swiper-slide>
        <v-card>
          ...
          <v-card-actions class="d-flex">
            <v-rating size="md" hover color="primary" half-increments></v-rating>
            <v-spacer></v-spacer>
            <a href="https://prayer-alpha.vercel.app/"><v-btn color="blue-lighten-3"
                prepend-icon="mdi-share">view</v-btn></a>
          </v-card-actions>
        </v-card>
      </swiper-slide>
      ...
      <swiper-slide>
        <v-card>
          ...
          <v-card-actions class="d-flex">
            <v-rating size="md" hover color="primary" half-increments></v-rating>
            <v-spacer></v-spacer>
            <a href="https://e-commerce-18px.vercel.app/"><v-btn color="blue-lighten-3"
                prepend-icon="mdi-share">View</v-btn></a>
          </v-card-actions>
        </v-card>
      </swiper-slide>
      <swiper-slide>
        <v-card>
          ...
          <v-card-actions class="d-flex">
            <v-rating size="md" hover color="primary" half-increments></v-rating>
            <v-spacer></v-spacer>
            <a href="https://movie-app-umber-beta.vercel.app/"><v-btn color="blue-lighten-3"
                prepend-icon="mdi-share">view</v-btn></a>
          </v-card-actions>
        </v-card>
      </swiper-slide>
      <swiper-slide>
        <v-card>
          ...
          <v-card-actions class="d-flex">
            <v-rating size="md" hover color="primary" half-increments></v-rating>
            <v-spacer></v-spacer>
            <a href="https://amaj11.github.io/contact/"><v-btn color="blue-lighten-3"
                prepend-icon="mdi-share">view</v-btn></a>
          </v-card-actions>
        </v-card>
      </swiper-slide>
      ...
      <swiper-slide>
        <v-card>
          <v-card-title primary-title> Simple OnlineStore </v-card-title>
          <img src="../assets/A 204027.png" />
          <v-card-actions class="d-flex">
            <v-rating size="md" hover color="primary" half-increments></v-rating>
            <v-spacer></v-spacer>
            <a href="https://am-store-iota.vercel.app/"><v-btn color="blue-lighten-3"
                prepend-icon="mdi-share">view</v-btn></a>
          </v-card-actions>
        </v-card>
      </swiper-slide>
      ...
      <v-row class="mt-4 pa-5">
        ...
        <v-col sm="6" cols="12">
          <v-card variant="outlined" class="bg-grey-lighten-3">
            <div class="bg-grey"> <v-card-title>MovieApp</v-card-title>
              <v-card-text>
                <p> This App that you can search of movie and show trailer of movie and Actors & others<br> It
                  develope with vue js&vuetify&api </p>
              </v-card-text>
            </div>
            <v-divider :thickness="6" color="black" class="mb-2"></v-divider>
            <v-img src="../assets/5.png" style="width:100%;max-height:350px"></v-img>
        ...
        <v-col sm="6" cols="12">
          <v-card class="bg-grey-lighten-3" variant="outlined">
            ...
            <v-divider :thickness="6" color="black" class="mb-2"></v-divider>
            <v-img src="../assets/Screenshot from 2024-10-24 11-37-09.png" style="width:100%;max-height:350px"></v-img>
            <v-img src="../assets/Screenshot from 2025-02-09 19-39-48 copy.png"
              style="width:100%;max-height:350px"></v-img>
            <v-card-actions style="display: flex;justify-content: center;">
              <div>
        ...
        <v-col sm="6" cols="12">
          <v-card class="bg-grey-lighten-3" variant="outlined">
            <div class="bg-success"> <v-card-title>E-commerce Website</v-card-title>
              <v-card-text>
                <p> An full Ecommerce Website <br> It develope with vue js&vuetify&api </p>
              </v-card-text>
            </div>

            <v-divider :thickness="6" color="black" class="mb-2"></v-divider>
            <v-img src="../assets/Screenshot from 2024-10-24 11-40-57.png" style="width:100%;max-height:350px"></v-img>
        ...
        <v-col sm="6" cols="12">
          <v-card class="bg-grey-lighten-3" variant="outlined">
            <div class="bg-brown"> <v-card-title>Contact Manager</v-card-title>
              <v-card-text>
                <p> This CRUD App that you can manage your contacts It develope with vue </p>
              </v-card-text>
            </div>

            <v-divider :thickness="6" color="black" class="mb-2"></v-divider>
            <v-img src="../assets/3.png" style="width:100%;max-height:350px"></v-img>
